...
public class CipherBlockChainingCryptographer 
    : BaseCryptographer<CipherBlockChainingCryptographerOptions>
{

    private CipherBlockChainingCryptographerOptions _options;
    private readonly Encoding _encoding;

    public CipherBlockChainingCryptographer()
        : base(CipherBlockChainingCryptographerOptions.Default)
    {
